...
def base_stats():
    ...
    for row in results:
        pokedatalist = []
        pokedatalist.append(row[0])
        pokedatalist.append(row[1])
        pokedatalist.append(row[2])
        pokedatalist.append(row[3])
        pokedatalist.append(row[4])
        pokedatamaster.append(pokedatalist)

    return jsonify(pokedatamaster)
...
def fast_move_stats():
    ...
    for row in results:
        ...
        pokedatalist.append(row[3])
        pokedatalist.append(row[4])
        pokedatalist.append(row[5])
        pokedatalist.append(row[6])
        pokedatamaster.append(pokedatalist)
