 ...
 */
{
    class Details {
        constructor() {
            ...
            <img class="details__img" src="" alt="img 01" id='Pogo'/>
            <h2 class="details__title"></oh2>
            <div class="details__deco"></div>
            <h3 class="details__subtitle"></h3>
            <div class="details__price"></div>
            <p class="details__description"></p>
            <button class="details__addtocart">Pokemon</button>
    ...
    class Item {
        ...
        open() {
            this.info.img = d3.select("#Pogo").attr('src')
            this.info.title = d3.select(".product__title").text()
            this.info.subtitle = d3.select(".product__subtitle").text()
            this.info.price = d3.select(".product__price").text()
            // this.info.description =d3.select(".product_description").text()
